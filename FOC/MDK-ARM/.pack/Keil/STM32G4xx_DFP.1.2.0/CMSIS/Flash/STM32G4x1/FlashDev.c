...
struct FlashDevice const FlashDevice  =  {
   ...
   "STM32G4x1 512 Flash",      // Device Name (512kB)
   ONCHIP,                     // Device Type
   0x08000000,                 // Device Start Address
   0x00080000,                 // Device Size in Bytes (512kB)
   1024,                       // Programming Page Size (2 Kbyte)
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32G4x1 256 Flash",      // Device Name (512kB)
   ONCHIP,                     // Device Type
   0x08000000,                 // Device Start Address
...
// Specify Size and Address of Sectors
   0x800, 0x000000,            // Sector Size  2kB (512 Sectors)
   SECTOR_END
};
#endif
