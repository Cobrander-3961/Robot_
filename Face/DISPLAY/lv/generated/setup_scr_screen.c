...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_1, &_laugh_alpha_172x173);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 71, 32);
    lv_obj_set_size(ui->screen_img_1, 172, 173);
    ...
    lv_img_set_src(ui->screen_img_2, &_scare_alpha_189x192);
    lv_img_set_pivot(ui->screen_img_2, 50,50);
    lv_img_set_angle(ui->screen_img_2, 0);
    lv_obj_set_pos(ui->screen_img_2, 61, 28);
    lv_obj_set_size(ui->screen_img_2, 189, 192);
